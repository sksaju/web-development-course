<?php 
    ...
    if($method=='POST') {
        ...
        if($msg != null) {
            ...
            if($id) {
                $save = $crud->execute("UPDATE system_users SET username='$username',email='$email',phone='$phone',address='$address',status='$status' WHERE id=$id");
            } else {
                $save = $crud->execute("INSERT INTO system_users(username, email, phone, address, status) VALUES('$username','$email','$phone','$address','$status')");
                $_POST = array();
            }
                        ...
                        <div class="panel-body">
                            ...
                            <form role="form" action="system_users_form.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="username" name="username" value="<?php echo @$_POST['username']; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Email Address</label>
                                    <input class="form-control" id="email" name="email" value="<?php echo @$_POST['email']; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Phone Number</label>
                                    <input class="form-control" id="phone" name="phone" value="<?php echo @$_POST['phone']; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Address</label>
